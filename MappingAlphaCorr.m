...
dlmwrite(['Sector1AlphaCorr_',num2str(n)],[rho,f,S,TH]);
...
%and the angular displacment f. We also record the values of S and TH so
%that they do not have to be reconstructed.
dlmwrite(['Sector2AlphaCorr_',num2str(n)],[rho,f,S,TH]);
...
%and the angular displacment f. We also record the values of S and TH so
%that they do not have to be reconstructed.
dlmwrite(['Sector3AlphaCorr_',num2str(n)],[rho,f,S,TH]);
...
%and the angular displacment f. We also record the values of S and TH so
%that they do not have to be reconstructed.
dlmwrite(['Sector4AlphaCorr_',num2str(n)],[rho,f,S,TH]);

hold off;
saveas(f1,['mappingAlphaCorr_',num2str(n)],'fig');
end

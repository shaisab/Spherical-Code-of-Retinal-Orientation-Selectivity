function []= VecDataRad(polarity,discPoints)
...
U1=RHO1.*cos(F1);
V1=RHO1.*sin(F1);
vecU1=vecU1.*polarity;
vecV1=vecV1.*polarity;
...
U2=RHO2.*cos(F2);
V2=RHO2.*sin(F2);
vecU2=vecU2.*polarity;
vecV2=vecV2.*polarity;
...
U3=RHO3.*cos(F3);
V3=RHO3.*sin(F3);
vecU3=vecU3.*polarity;
vecV3=vecV3.*polarity;
...
U4=RHO4.*cos(F4);
V4=RHO4.*sin(F4);
vecU4=vecU4.*polarity;
vecV4=vecV4.*polarity;

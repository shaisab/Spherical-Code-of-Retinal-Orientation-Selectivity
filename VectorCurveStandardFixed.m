...
function [] = VectorCurveStandard(fieldType,Normal,discPoints,plotType,graphcolor,VizAngle)
...
n=200; %Number of discretization points for the curve.
...
for i=1:n
    ...
    elseif thret1(i)>=pi/2 & thret1(i)<pi,
        %Calculation of closest grid point.
    ...
    elseif thret1(i)>=pi & thret1(i)<3*pi/2,
        %Calculation of closest grid point.
    ...
    elseif thret2(i)>=pi/2 & thret2(i)<pi,
        %Calculation of closest grid point.
    ...
    elseif thret2(i)>=pi & thret2(i)<3*pi/2,
        %Calculation of closest grid point.
    ...
    elseif thret3(i)>=pi/2 & thret3(i)<pi,
        %Calculation of closest grid point.
    ...
    elseif thret3(i)>=pi & thret3(i)<3*pi/2,
        %Calculation of closest grid point.
   ...
   if isnan(sret4(i)),
    ...
    elseif thret4(i)>=pi/2 & thret4(i)<pi,
        %Calculation of closest grid point.
    ...
    elseif thret4(i)>=pi & thret4(i)<3*pi/2,
        %Calculation of closest grid point.
    ...
    elseif thret5(i)>=pi/2 & thret5(i)<pi,
        %Calculation of closest grid point.
    ...
    elseif thret5(i)>=pi & thret5(i)<3*pi/2,
        %Calculation of closest grid point.
    ...
    elseif thret6(i)>=pi/2 & thret6(i)<pi,
        %Calculation of closest grid point.
    ...
    elseif thret6(i)>=pi & thret6(i)<3*pi/2,
        %Calculation of closest grid point.
   ...
   if isnan(sret7(i)),
    ...
    elseif thret7(i)>=pi/2 & thret7(i)<pi,
        %Calculation of closest grid point.
    ...
    elseif thret7(i)>=pi & thret7(i)<3*pi/2,
        %Calculation of closest grid point.
    ...
    elseif thret8(i)>=pi/2 & thret8(i)<pi,
        %Calculation of closest grid point.
    ...
    elseif thret8(i)>=pi & thret8(i)<3*pi/2,
        %Calculation of closest grid point.
...
%     alpha(.25);
    ...
    surf(StU1,StV1,zeros(40,40),'EdgeColor','none');
    surf(StU2,StV2,zeros(40,40),'EdgeColor','none');
    surf(StU3,StV3,zeros(40,40),'EdgeColor','none');
    surf(StU4,StV4,zeros(40,40),'EdgeColor','none');

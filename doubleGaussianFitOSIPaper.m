function [oriFWHM,u,k,gof2,x,xq,Rq]= doubleGaussianFitOSIPaper(d,a)
...
fo = fitoptions('Method','NonlinearLeastSquares',...
               ...
               'TolFun',1.0E-12,... 
               'TolX',1.0E-12,...
               'Lower',[max(ma)-min(ma),0,0],...
               'Upper',[3*max(ma),135,180],...
               'StartPoint',[max(ma)-min(ma),45,90]);

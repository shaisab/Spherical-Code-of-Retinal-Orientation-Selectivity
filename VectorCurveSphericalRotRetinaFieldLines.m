function [] = VectorCurveSphericalRotRetinaFieldLines(alphabar,beta,discPoints,VizAngle,lc)
...
C11=[RV*cos(t)*sin(11*CL);RV*sin(t)*sin(11*CL);-RV*cos(11*CL)*ones(1,n)];
C12=[RV*cos(t)*sin(12*CL);RV*sin(t)*sin(12*CL);-RV*cos(12*CL)*ones(1,n)];
C13=[RV*cos(t)*sin(13*CL);RV*sin(t)*sin(13*CL);-RV*cos(13*CL)*ones(1,n)];
C14=[RV*cos(t)*sin(14*CL);RV*sin(t)*sin(14*CL);-RV*cos(14*CL)*ones(1,n)];
C15=[RV*cos(t)*sin(15*CL);RV*sin(t)*sin(15*CL);-RV*cos(15*CL)*ones(1,n)];
C16=[RV*cos(t)*sin(16*CL);RV*sin(t)*sin(16*CL);-RV*cos(16*CL)*ones(1,n)];
C17=[RV*cos(t)*sin(17*CL);RV*sin(t)*sin(17*CL);-RV*cos(17*CL)*ones(1,n)];
C18=[RV*cos(t)*sin(18*CL);RV*sin(t)*sin(18*CL);-RV*cos(18*CL)*ones(1,n)];
C19=[RV*cos(t)*sin(19*CL);RV*sin(t)*sin(19*CL);-RV*cos(19*CL)*ones(1,n)];
C20=[RV*cos(t)*sin(20*CL);RV*sin(t)*sin(20*CL);-RV*cos(20*CL)*ones(1,n)];

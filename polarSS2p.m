function hpol = polarSS2p(varargin)
...
%             line_style = 'auto';
    ...
    elseif nargs == 1
        ...
        [theta, rho, rticks, line_style] = deal(args{1 : 4});
    end
    ...
    if ~hold_state
        ...
        for i = (rmin + rinc) : rinc : rmax
            hhh = line(xunit * i, yunit * i, 'LineStyle', ls, 'Color', tc, 'LineWidth', 0.5, ...
                'HandleVisibility', 'off', 'Parent', cax);
...
%                 'HandleVisibility', 'off', 'Parent', cax);
        ...
        cs = [-cst; cst];
        sn = [-snt; snt];
        line(rmax * cs, rmax * sn, 'LineStyle', ls, 'Color', [0 0 0], 'LineWidth', 0.5, ...
            'HandleVisibility', 'off', 'Parent', cax);
    ...
    if strcmp(line_style, 'auto')
        ...
        q = plot(xx, yy, 'color',line_style,'LineWidth',line_width, 'Parent', cax);
    end

function []=SphericalContourAlphaBetaAxes(resolution)
...
%lb=-1;
lb=0;
ubNasal=5*coeffONOFF(1);          %3
ubDorsal=5*coeffONOFF(2);       %3      3 for nonCART
ubTemporal=5*coeffONOFF(3);     %1.1
ubVentral=5*coeffONOFF(4);      %1.7    3 for Hb9
...
Cylinder([xl(1),yl(1),zl(1)],[xl(end),yl(end),zl(end)],0.015,20,'b',1,0);
...
Cylinder([xl(1),yl(1),zl(1)],[xl(end),yl(end),zl(end)],0.015,20,'g',1,0);
...
Cylinder([xl(1),yl(1),zl(1)],[xl(end),yl(end),zl(end)],0.015,20,'r',1,0);
...
Cylinder([xl(1),yl(1),zl(1)],[xl(end),yl(end),zl(end)],0.015,20,'m',1,0)

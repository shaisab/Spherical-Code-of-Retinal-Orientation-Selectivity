function [voronoi_areas, voronoi_vertices, vdari] = calculate_voronoi_vdari(x_coords, y_coords, n_random_points, bounding_polygon, visualize)
...
%     y_coords_selected = y_coords(selected_indices);
    ...
    x_coords_selected = x_coords;
    y_coords_selected = y_coords;

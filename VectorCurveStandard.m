...
function [] = VectorCurveStandard(fieldType,Normal,alphaTrans,betaTrans,discPoints,plotType,graphcolor,VizAngle)
...
if isempty(Normal)
alphabar=deg2rad(alphaTrans);
beta=deg2rad(betaTrans);
else

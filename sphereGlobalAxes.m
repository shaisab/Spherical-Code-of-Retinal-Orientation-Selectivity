function channels = sphereGlobalAxes()
...
% set(gca,'color',[1 1 1]);
% 
%% draw the normal of translation singularities as cylinders
lb=0;
ub=1;
...
% flip the axes such that they point the direction of motion of the animal
% need to excite the concerned cells
...
%% draw the normal of rotation singularities as cylinders
lb=0;
ub=1;
lambda=linspace(lb,ub,100);

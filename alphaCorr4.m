...
%% load meridian_radius, map, and phys files
...
%% apply alpha correction and save physAlphaCorr
...
a_tmp=sort([mod(a1+deg2rad(map.alphaCorr),2*pi),mod(a2+deg2rad(map.alphaCorr),2*pi),mod(a3+deg2rad(map.alphaCorr),2*pi),mod(a4+deg2rad(map.alphaCorr),2*pi)]);
...
Sec1Data=dlmread(['Sector2_',num2str(discPoints)]);
Sec2Data=dlmread(['Sector3_',num2str(discPoints)]);
Sec3Data=dlmread(['Sector4_',num2str(discPoints)]);
Sec4Data=dlmread(['Sector1_',num2str(discPoints)]);
end

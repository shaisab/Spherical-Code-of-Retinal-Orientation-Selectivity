function [alpha,beta,Normal]= ABRetina2GlobalVisualRight(Normal)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   This code converts a normal passing from the ORIGIN OUTWARD in retinal
%   space into a normal passing from the ORIGIN OUTWARD in the global
%   visual space and then converts this to a normal and alpha beta on the 
%   retina.
%
%   Inputs
...
% axis [0,0,1] into the optical axis in global visual space. 
% The sequence of rotations is the following:
%
...
Rot=[0.907945,-0.102142,0.406451;...

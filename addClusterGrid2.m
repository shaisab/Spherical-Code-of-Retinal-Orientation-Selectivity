...
function pooledmap = addClusterGrid2(pooledmap,COLORstate,f1,f2,f3)
...
plot([nodes(1,1),nodes(2,1),nodes(3,1),nodes(4,1)],[nodes(1,2),nodes(2,2),nodes(3,2),nodes(4,2)],'r-');
...
for c=1:size(ind,1)
    if pooledmap.Itrans(ind(c))==1
        quiver(repmat((nodes(2,1)-0.1),size(pooledmap.UVStvecComp.VecUSt(ind(c)),1),1),repmat((nodes(2,2)+0.1),size(pooledmap.UVStvecComp.VecUSt(ind(c)),1),1),pooledmap.UVStvecComp.VecUSt(ind(c)),pooledmap.UVStvecComp.VecVSt(ind(c)),scale,'b');
    elseif pooledmap.Itrans(ind(c))==2
        quiver(repmat((nodes(2,1)-0.1),size(pooledmap.UVStvecComp.VecUSt(ind(c)),1),1),repmat((nodes(2,2)+0.1),size(pooledmap.UVStvecComp.VecUSt(ind(c)),1),1),pooledmap.UVStvecComp.VecUSt(ind(c)),pooledmap.UVStvecComp.VecVSt(ind(c)),scale,'g');
    elseif pooledmap.Itrans(ind(c))==3
        quiver(repmat((nodes(2,1)-0.1),size(pooledmap.UVStvecComp.VecUSt(ind(c)),1),1),repmat((nodes(2,2)+0.1),size(pooledmap.UVStvecComp.VecUSt(ind(c)),1),1),pooledmap.UVStvecComp.VecUSt(ind(c)),pooledmap.UVStvecComp.VecVSt(ind(c)),scale,'r');
    elseif pooledmap.Itrans(ind(c))==4
        quiver(repmat((nodes(2,1)-0.1),size(pooledmap.UVStvecComp.VecUSt(ind(c)),1),1),repmat((nodes(2,2)+0.1),size(pooledmap.UVStvecComp.VecUSt(ind(c)),1),1),pooledmap.UVStvecComp.VecUSt(ind(c)),pooledmap.UVStvecComp.VecVSt(ind(c)),scale,'k');
    end
end   

function channels = sphereGlobalAxesRightAndLeft()
...
% set(gca,'color',[1 1 1]);
% 
%% draw the normal of Right translation singularities as cylinders
lb=0;
ub=1;
...
%% draw the normal of Left translation singularities as cylinders
lb=0;
ub=1;
lambda=linspace(lb,ub,100);

for i=1:size(Left.translation,2)
alphasing(1,i)=Left.translation{1,i}(1);       % I flipped alpha to correspond to vestibular axes
betasing(1,i)=Left.translation{1,i}(2);        
end
...
%% draw the normal of Right rotation singularities as cylinders
...
%% draw the normal of Left rotation singularities as cylinders
...
for i=1:size(Left.rotation,2)
alphasingRot(1,i)=Left.rotation{1,i}(1);
betasingRot(1,i)=Left.rotation{1,i}(2);
end

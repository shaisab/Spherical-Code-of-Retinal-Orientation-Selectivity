...
for i=1:length(pooledmap.cellID)
           
rho=[pooledmap.meanr(i,:),pooledmap.meanr(i,1)];
...
P=polarSS2p(deg2rad(pooledmap.theta(i,:)),rho./max(rho),1,[0.3010 0.7450 0.9330],6);
...
[X,Y]=pol2cart(deg2rad([pooledmap.poriSz(i),pooledmap.poriSz(i)+180]'), 1);

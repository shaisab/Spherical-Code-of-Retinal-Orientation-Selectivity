function [allPossibleFields]= VecComparisonPooled2valid(pooledmap,alpha,beta,polarity,fieldType,VizAngle,allPossibleFields,k,h)
...
%%% observed vectors are set to the vector field around the ASC and LSC
%%% canals
